...
inline void IMGP_data_convert(const TS *pSrc, unsigned int sp0, unsigned int sp1, TD *pDst, unsigned int dp0, unsigned int dp1, double ratio, double offset)
{
...
#define IMGP_DATA_FUNC(a,b,c,d) \
	inline void IMGP_data_##a##b##c##d##_convert(const void *pSrc, unsigned int sp0, unsigned int sp1, void *pDst, unsigned int dp0, unsigned int dp1, double ratio, double offset) \
	{\
		IMGP_data_convert((const a b*)pSrc, sp0, sp1, (c d*)pDst, dp0, dp1, ratio, offset);\
	}\
...
typedef void(*DataConvertFunc)(const void *pSrc, unsigned int sp0, unsigned int sp1, void *pDst, unsigned int dp0, unsigned int dp1, double ratio, double offset);
